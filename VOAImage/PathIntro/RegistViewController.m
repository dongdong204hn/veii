...
//    UIImageView *backgroundView = Nil;
    ...
    if (isiPhone) {
        [logo setFrame:CGRectMake(60, 300, 200, 90)];
...
//                [cell sendSubviewToBack:lineView];
                ...
                [userL setTextColor:[UIColor colorWithRed:74.0/255 green:66.0/255 blue:70.0/255 alpha:1]];
...
//                [cell sendSubviewToBack:lineView];
                ...
                [codeL setTextColor:[UIColor colorWithRed:74.0/255 green:66.0/255 blue:70.0/255 alpha:1]];
...
//                [cell sendSubviewToBack:lineView];
                ...
                [codeAgainL setTextColor:[UIColor colorWithRed:74.0/255 green:66.0/255 blue:70.0/255 alpha:1]];
...
//                [cell sendSubviewToBack:lineView];
                ...
                [mailL setText:@"Email:"];
                [mailL setTextColor:[UIColor colorWithRed:74.0/255 green:66.0/255 blue:70.0/255 alpha:1]];
...
//                [registBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
                ...
                if (isiPhone) {
                    [registBtn setFrame:CGRectMake(220, 5, 80, 35)];
                    [registBtn setImage:[UIImage imageNamed:@"submitBtn.png"] forState:UIControlStateNormal];
                    [registBtn setImage:[UIImage imageNamed:@"submitBtnPres.png"] forState:UIControlStateHighlighted];
